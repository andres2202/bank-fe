    ...
    export default{
        ...
        methods:{
            getData: async function (){
                ...
                axios.get(`https://bank-be-app.herokuapp.com/user/${userId}/`, {headers: {'Authorization': `Bearer ${token}`}})
                .then((result) => {
                ...
                .catch(() =>{
                    alert("Failed token_access");
                    this.$emit('logOut');
                });
            },

            verifyToken: function (){
                return axios.post("https://bank-be-app.herokuapp.com/refresh/", 
